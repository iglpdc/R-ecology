...
If you need to convert a factor to a character vector, you simply use
`as.character(x)`.

Converting a factors where the levels appear as numbers (such as in
concentration levels) to a numeric vector is however a little trickier, and you
...
Notice that in this last approach, three important steps occur:
